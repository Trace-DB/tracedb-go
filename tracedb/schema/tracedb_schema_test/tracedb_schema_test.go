...
func TestTracedbSchemaPostSchemaApplyWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Tracedb.Schema.PostSchemaApply(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestTracedbSchemaPostSchemaApplyWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestTracedbSchemaPostSchemaApplyWithWireMock", "POST", "/v1/schema/apply", nil, 1)
}
